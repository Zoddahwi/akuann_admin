export default function AdminDashboardPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-16">
      <h1 className="text-3xl font-semibold text-neutral-900 tracking-tight">Admin Dashboard</h1>
      <p className="mt-4 text-neutral-600 leading-relaxed max-w-xl">
        Select a section below to manage your bespoke bridal studio operations.
      </p>

      <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link 
          href="/admin/gowns" 
          className="group relative overflow-hidden rounded-[32px] border border-neutral-200 bg-white p-8 transition-all hover:border-primary/30 hover:shadow-xl hover:-translate-y-1"
        >
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-neutral-100 text-neutral-600 transition-colors group-hover:bg-primary/10 group-hover:text-primary">
            <Scissors size={20} />
          </div>
